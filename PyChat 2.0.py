...
def correct_input(cmd):
    ...
    variations = [
        ...
        ('whatcanyou do', 'what can you do'),
        ('whatcanyoudo', 'what can you do'),
        ('what canyou do', 'what can you do'),
        ('what can youdo', 'what can you do'),
        ('openmy account', 'open my account'),
        ('openmyaccount', 'open my account'),
        ('open myaccount', 'open my account'),
        ('openmyacount', 'open my account'),
        ('showme my current location', 'show me my current location'),
        ('showmemy current location', 'show me my current location'),
        ('showmemycurrent location', 'show me my current location'),
        ('showmemycurrentlocation', 'show me my current location'),
        ('show me my location', 'show me my current location'),
        ('showme my location', 'show me my current location'),
        ('showmemy location', 'show me my current location'),
        ('showmemylocation', 'show me my current location'),
        ('show memy current location', 'show me my current location'),
        ('show me mycurrent location', 'show me my current location'),
        ('show me my currentlocation', 'show me my current location'),
        ('show memy location', 'show me my current location'),
        ('show me mylocation', 'show me my current location'),
        ('show me location', 'show me my current location'),
        ('showme location', 'show me my current location'),
        ('show melocation', 'show me my current location'),
        ('tellme a joke', 'tell me a joke'),
        ('tellmea joke', 'tell me a joke'),
        ('tellmeajoke', 'tell me a joke'),
        ('tell mea joke', 'tell me a joke'),
        ('tell me ajoke', 'tell me a joke'),
        ('tell a joke', 'tell me a joke'),
        ('tella joke', 'tell me a joke'),
        ('tellajoke', 'tell me a joke'),
        ('tell ajoke', 'tell me a joke'),
        ('tell joke', 'tell me a joke'),
        ('telljoke', 'tell me a joke'),
        ('tellme a fun fact', 'tell me a fun fact'),
        ('tellmea fun fact', 'tell me a fun fact'),
        ('tellmeafun fact', 'tell me a fun fact'),
        ('tellmeafunfact', 'tell me a fun fact'),
        ('tell mea fun fact', 'tell me a fun fact'),
        ('tell me afun fact', 'tell me a fun fact'),
        ('tell me a funfact', 'tell me a fun fact'),
        ('tell a fun fact', 'tell me a fun fact'),
        ('tella fun fact', 'tell me a fun fact'),
        ('tellafun fact', 'tell me a fun fact'),
        ('tellafunfact', 'tell me a fun fact'),
        ('tell afun fact', 'tell me a fun fact'),
        ('tell a funfact', 'tell me a fun fact'),
        ('tell fun fact', 'tell me a fun fact'),
        ('tellfun fact', 'tell me a fun fact'),
        ('tellfunfact', 'tell me a fun fact'),
        ('tell funfact', 'tell me a fun fact'),
        ('tell fact', 'tell me a fun fact'),
        ('tellfact', 'tell me a fun fact'),
        ('startdrawing', 'start drawing'),
        ('seta timer', 'set a timer'),
        ('set atimer', 'set a timer'),
